...
export function SiteFooter() {
  return (
    <footer className="site-footer site-footer-expanded">
      ...
      <div className="footer-contact"><strong>项目咨询</strong><a href="mailto:sales@rise-elec.com">sales@rise-elec.com</a><a href="tel:+8657762788168">+86 577 6278 8168</a><small>浙江省乐清市柳市镇<br />浙江升昇电气有限公司</small></div>
...
export function CtaBand({ title = "把项目需求，交给我们一起梳理。" }: { title?: string }) {
  return <section className="quote-section"><div className="quote-inner section-shell"><div><p className="eyebrow light">准备开始了吗？</p><h2>{title}</h2><p>告诉我们产品方向、应用场景、数量和交期，我们会从最关键的技术问题开始，为你准备下一步。</p></div><div className="contact-card"><span className="contact-label">RISE 项目咨询</span><a href="mailto:sales@rise-elec.com">sales@rise-elec.com</a><a href="tel:+8657762788168">+86 577 6278 8168</a><span className="contact-address">浙江省乐清市柳市镇<br />浙江升昇电气有限公司</span><Link className="button button-light" href="/contact">提交项目需求 <span aria-hidden="true">→</span></Link></div></div></section>;
}
